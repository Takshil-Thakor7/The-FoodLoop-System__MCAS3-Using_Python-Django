...
urlpatterns = [
    ...
    path('food-businesses/', views.food_business_list, name='food_business_list'),
    path('food-businesses/<int:business_id>/edit/', views.food_business_edit, name='food_business_edit'),
    path('food-businesses/<int:business_id>/delete/', views.food_business_delete, name='food_business_delete'),

    path('ngos/', views.ngo_list, name='ngo_list'),
    path('ngos/<int:ngo_id>/edit/', views.ngo_edit, name='ngo_edit'),
    path('ngos/<int:ngo_id>/delete/', views.ngo_delete, name='ngo_delete'),
    ...
    path('volunteers/<int:volunteer_id>/edit/', views.volunteer_edit, name='volunteer_edit'),
    ...
    path('food-items/<int:item_id>/edit/', views.food_item_edit, name='food_item_edit'),
    path('food-items/<int:item_id>/delete/', views.food_item_delete, name='food_item_delete'),

    path('food-eligibility/', views.food_eligibility_list, name='food_eligibility_list'),
    path('food-eligibility/<int:eligibility_id>/edit/', views.food_eligibility_edit, name='food_eligibility_edit'),
    path('food-eligibility/<int:eligibility_id>/delete/', views.food_eligibility_delete, name='food_eligibility_delete'),

    path('food-requests/', views.food_request_list, name='food_request_list'),
    path('food-requests/<int:request_id>/edit/', views.food_request_edit, name='food_request_edit'),
    path('food-requests/<int:request_id>/delete/', views.food_request_delete, name='food_request_delete'),
    ...
    path('pickups/<int:pickup_id>/edit/', views.pickup_edit, name='pickup_edit'),
    path('pickups/<int:pickup_id>/delete/', views.pickup_delete, name='pickup_delete'),
    ...
    path('analytics/<int:analytics_id>/edit/', views.analytics_edit, name='analytics_edit'),
    path('analytics/<int:analytics_id>/delete/', views.analytics_delete, name='analytics_delete'),
]
